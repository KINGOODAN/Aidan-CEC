...
int wallCollide(int x, int y, int dir, int level[31][29]) {
	...
	// Check along the far right side of the sprite, plus 3 (the speed we’re moving)
		new_x1 = x + 3 + PACSIZE * 2; //multiplying by 2 since PACSIZE is the radius
		new_x2 = x + 3 + PACSIZE * 2;
		new_x3 = x + 3 + PACSIZE * 2;
		...
		//Check at three points along that edge
		new_y1 = y + 3 + PACSIZE * 2;
		new_y2 = y + 3 + PACSIZE * 2;
		new_y3 = y + 3 + PACSIZE * 2;
